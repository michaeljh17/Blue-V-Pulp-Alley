...
test.add_character_then_run_creation_method_check("Create a Leader, When there is already a leader",
                                False,"Danny", "Leader","d10","3d10","3d10",
                                "3d8","3d10","2d8","2d10","Mighty","Brash",
                                "Crafty")

test.add_character_then_run_creation_method_check("Create a Leader, When there is already a leader with the same name", 
