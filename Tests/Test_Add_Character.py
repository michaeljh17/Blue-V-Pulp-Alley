...
class Test_Add_Character(object):
    ...
    def delete_bruce(self):
        self.lm.get_current_league().delete_character_by_name("Bruce")

    def check_character_creation_methods(self, tests_name, expectation, name,
                                         char_type, health, brawl, shoot,
                                         dodge, might, finesse, cunning,
                                         *abilities):
        print("Beginning Test: " + tests_name)
        self.lm.get_current_league().add_character(name, char_type, health,
                                                   brawl, shoot, dodge, might,
                                                   finesse, cunning,
                                                   arg1=abilities[0],
                                                   arg2=abilities[1],
                                                   arg3=abilities[2])
    ...
    def add_character_then_run_creation_method_check(self, tests_name,
                                                     expectation, name,
                                                     char_type, health, brawl,
                                                     shoot, dodge, might,
                                                     finesse, cunning,
                                                     *abilities):
        print("Beginning Test: " + tests_name)
