...
class Test_Add_Character(object):
    ...
    def add_bruce(self):
        self.lm.get_current_league().add_character("Bruce", char_type="Leader", health="d10",
    ...
    def add_character_then_run_creation_method_check(self, tests_name, expectation,
                                                     name, char_type, health, brawl,
                                                     shoot, dodge, might, finesse,
                                                     cunning, *abilities):
        print("Beginning Test: " + tests_name)
        self.add_bruce()
